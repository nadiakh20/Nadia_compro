    ...
    <div class="container-fluid p-0">
        ...
        <section class="resume-section" id="experience">
            <div class="resume-section-content">
                ...
                <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                    ...
                    <div class="flex-shrink-0"><span class="text-primary">{{$experience->start_date}} - {{$experience->last_date}}</span></div>
                </div>
                @endforeach
            </div>
        </section>
        ...
        <section class="resume-section" id="education">
            <div class="resume-section-content">
                ...
                <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                    <div class="flex-grow-1">
                        <h3 class="mb-0">{{$education->instansi}}</h3>
                        <div class="subheading mb-3">{{$education->gelar}}</div>
                        <div>{{$education->major}}</div>
                        <p>{{$education->grade}}</p>
                    </div>
                    <div class="flex-shrink-0"><span class="text-primary">{{$education->start_date}} - {{$education->last_date}}</span></div>
                </div>
                @endforeach
            </div>
        </section>
